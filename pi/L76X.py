...
class L76X(object):
    ...
    def L76X_Gat_GNRMC(self):
        ...
        for i in range(0, BUFFSIZE - 71):
            ...
            if ord(data[add]) == 36 and ord(data[add + 1]) == 71 and (ord(data[add + 2]) == 78 or ord(data[add + 2]) == 80) and ord(data[add + 3]) == 82 and ord(data[add + 4]) == 77 and ord(data[add + 5]) == 67:
                x = 0
                z = 0
                while (x < 12):
                    if add + z >= BUFFSIZE - 1:
                        return
                    elif ord(data[add + z]) == 44:
                        x = x + 1
                        if x == 1:
                            Time = 0
                            ...
                            for k in range(0, BUFFSIZE - 1):
                                ...
                                elif ord(data[add + z + k + 1]) == 44:

                                    break

                                elif ord(data[add + z + k + 1]) == 46:
